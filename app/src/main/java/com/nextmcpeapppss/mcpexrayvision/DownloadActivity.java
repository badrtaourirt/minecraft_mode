...
public class DownloadActivity extends AppCompatActivity implements AdsManagerListener {
    ...
    public void onButtonClick(View view) {
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                copyAssets(DownloadActivity.this,Configs.MOD_FILE_NAME);
    ...
    public void onNextButtonClick(View view) {
        ...
        if(adsManager.OnOff == 1) {
            waitingads = new Dialog(DownloadActivity.this);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(DownloadActivity.this, DetailActivity.class);
        startActivity(i);
        finish();
    ...
    public static void copyAssets(Context context, String filename) {
        ...
        try {
            ...
            copyFile(in, out);
            Log.d("Moew", " asset file Coped: " + filename);
        } catch(IOException e) {
            Log.d("Moew", "Failed to copy asset file: " + filename, e);
        }
        finally {
            if (in != null) {
                try {
